...
# -*- coding: utf-8 -*-
"""
Package metadata for custom_student_verification.
"""
...
VERSION = get_version('custom_student_verification', '__init__.py')
...
setup(
    ...
    entry_points={
        'lms.djangoapp': [
            'custom_student_verification_app = custom_student_verification.apps:CustomStudentVerificationConfig'
        ]
    }
)
